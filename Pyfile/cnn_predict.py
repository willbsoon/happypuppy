...
################################################ 분석 이미지 전처리
imgfile= sys.argv[1]
#imgfile="C:\\Users\\apfhd\\Documents\\eclipse_data\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\project_0816_merge\\animalImage\\black.png"
...
with tf.Session() as sess:
    sess.run(init_op)
    ## 학습결과 덤핑 파일
    save_path = "C:/Users/apfhd/Documents/py_connector/image/cnn_model.ckpt"
#    save_path = "/usr/local/tomcat/webapps/py/cnn_model.ckpt"
