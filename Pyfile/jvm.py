...
def init_jvm(jvmpath=None):
    ...
    folder_suffix = [
        ...
        '{0}{1}hive-jdbc-1.2.2-standalone.jar','{0}{1}mysql-connector-java-5.1.42-bin.jar',
        '{0}{1}snakeyaml-1.12.jar', '{0}{1}scala-library-2.11.4.jar', '{0}{1}twitter-korean-text-2.4.3.jar', '{0}{1}twitter-text-1.10.1.jar',
        '{0}{1}*']
#'C:/Users/BS_Laptop/Documents/eclipse data/webproject6/WebContent/WEB-INF/lib/hive-jdbc-1.2.2-standalone.jar',
#       'C:/Program Files/MySQL/mysql-connector-java-5.1.42/mysql-connector-java-5.1.42-bin.jar'
