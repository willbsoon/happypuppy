			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">회원들에게 하고싶은 말을 전해주세요</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="row">
								<div class="writeform">
									<form role="form" method="post" action="postUpdate.puppy?postNo=<%=request.getParameter("postNo")%>">
										...
										<div class="form-group">
											<label>이름</label>
											<%if (request.getParameter("update") == null) {/* 업데이트 싸인이 없다면 새로운 글쓰기 */
													if (loginedUser == null) {%>
											<input type="text" name="name" class="form-control" placeholder="이름을 입력해주세요">
											<%} else if (loginedUser != null) {%>
											<input class="form-control" id="disabledInput" name="name"
												type="text" value=<%=loginedUser.getName()%> disabled>
