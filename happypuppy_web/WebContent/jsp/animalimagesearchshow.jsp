...
<body>
<%
	ArrayList<Animal> animalList = (ArrayList<Animal>) request.getSession().getAttribute("animalListColor");
	...
	String colorCd2 ="";
	//색상이 미상이 아니고 흰색이면
	if(!(colorCd.equals("미상")) && (colorCd.equals("흰"))){
		//반대 색상은 검은색
		colorCd2 = "검";
	//색상이 미상이 아니고 검은색이면
	}else if(!(colorCd.equals("미상")) && (colorCd.equals("검"))){
		//반대 색상은 흰색
		colorCd2 = "흰";
	}
			...
			<div class="row" id="listmaker">
				...
				<%
					for (int i = 0; i < animalList.size(); i++) {
						if((animalList.get(i).getColorCd().matches(".*"+colorCd+".*")) && 
								!(animalList.get(i).getColorCd().matches(".*"+colorCd2+".*"))){
							out.print(animalList.get(i).getColorCd()+"  "+colorCd+"<br>");
				%>
						...
						<div class="thumbnail-wrapper">
							<div class="thumbnail">
								...
								<figcaption>
									...
									<br> <br> <br>
									<h4><a href="animalDetail.puppy?popfile=<%out.print(animalList.get(i).getPopfile());%>">
											<%out.print(animalList.get(i).getProcessState());%>
										</a></h4>
									<br>
									<p><%out.print(animalList.get(i).getCareAddr());%></p>
									<%
										//if (i % 3 == 2) {out.print("<br><br>");}
									%>
		...
		<div class="container">
			<ul class="pagination">
				<%
					...
					int j = 0;
					for (j = 1; j < 6; j++) {out.print("<li><a href='123'>" + j + "</a></li>"); }
				%>
			</ul>
		</div>
	</section>
