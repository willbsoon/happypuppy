...
%>
<br/>
	<form action="userUpdate.puppy" method="post" name="user"
				...
				<!-- method="post" action="surveytest2.jsp"    -->
					<div class="form-group">
						<label for="InputEmail">이메일 주소</label> <input type="email"
							class="form-control" name="email" id="email" value=<%=loginedUser.getEmail()%>
							maxlength="50" disabled>

					</div>
					<div class="form-group">
						<label for="InputPassword1">*변경하실 비밀번호 입력</label> <input type="password"
							class="form-control" id="password" name="password" placeholder="비밀번호"
							maxlength="50">
					</div>
					<div class="form-group">
						<label for="InputPassword2">*변경하실 비밀번호 확인</label> <input
					...
					<div class="form-group text-center">
						...
						<a href="userdelete.jsp"><button type="button" class="btn" id="fault">
